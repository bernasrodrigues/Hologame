...
public class Hand :  MonoBehaviour
{
    ...
    private void UpdateHand()
    {
        ...
        float grip = actionBasedController.selectAction.action.ReadValue<float>();
        float trigger = actionBasedController.activateAction.action.ReadValue<float>();
